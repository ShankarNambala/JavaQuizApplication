...
public class Rules extends JFrame implements ActionListener{
    ...
    Rules(String name) {
        ...
        JLabel heading = new JLabel("Welcome  " + name + "!  Read the rules before you start.");
        ...
        rules.setText(
                ...
                "4. The Clock's Ticking! You Just have 15 secs to answer a question" + "<br><br>" +
